...
inline std::tuple<Tensor,Tensor,Tensor> dispatch_svd(const Tensor & self, bool some, bool compute_uv, Tensor & res1, Tensor & res2, Tensor & res3) {

  AutoNoGIL no_gil;
  return at::svd_out(res1, res2, res3, self, some, compute_uv);
}
